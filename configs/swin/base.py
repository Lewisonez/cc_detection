...
_base_ = [
    f"{mmdet_base}/models/faster_rcnn_swin_fpn.py",
...
custom_hooks = [
    ...
    dict(type="MeanTeacher", momentum=0.9, interval=1, warm_up=0),
]
evaluation = dict(type="SubModulesDistEvalHook", interval=4000)
optimizer = dict(type="SGD", lr=0.01, momentum=0.9, weight_decay=0.0001)#lr=0.01
lr_config = dict(step=[28000, 100000])#120000, 160000
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=18000)
checkpoint_config = dict(by_epoch=False, interval=10000, max_keep_ckpts=30)#原来是interval=4000
