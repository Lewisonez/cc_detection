...
def parse_args():
    ...
    parser.add_argument("--work-dir", default='final_results/ema02',help="the dir to save logs and models")
    parser.add_argument("--resume-from", default='final_results/ema02/iter_70000.pth',help="the checkpoint file to resume from")
    parser.add_argument(
        "--no-validate",
        action="store_true",
...
def main():
    ...
    print("model.CLASSES  " + str(model.CLASSES))
    train_detector(
        model,
        datasets,
        cfg,
